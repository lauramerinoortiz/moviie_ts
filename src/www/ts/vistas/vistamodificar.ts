...
export class VistaModificar extends Vista {
     ...
     public cancelar:HTMLInputElement
     public aceptar:HTMLInputElement
	...
	constructor(div:HTMLElement, controlador:Controlador) {
		super(div)
          ...
          this.nombre=<HTMLInputElement>document.getElementById('nombreEditar')
          this.descripcion=<HTMLInputElement>document.getElementById('descripcionEditar')
          this.fecha=<HTMLInputElement>document.getElementById('fechaEditar')
          this.duracion=<HTMLInputElement>document.getElementById('duracionEditar')
          this.imagen=<HTMLInputElement>document.getElementById('imagenEditar')

          this.netflix=<HTMLInputElement>document.getElementById('netflixEditar')
          this.netflix.onclick=this.anadirPlataforma.bind(this,'Netflix')

          this.hbo=<HTMLInputElement>document.getElementById('hboEditar')
          this.hbo.onclick=this.anadirPlataforma.bind(this, 'Hbo')

          this.disney=<HTMLInputElement>document.getElementById('disneyEditar')
          this.disney.onclick=this.anadirPlataforma.bind(this, 'Disney')

          this.amazon=<HTMLInputElement>document.getElementById('amazonEditar')
          this.amazon.onclick=this.anadirPlataforma.bind(this,'Amazon')

          this.cancelar=<HTMLInputElement>this.div.getElementsByTagName('button')[0]
          this.cancelar.onclick = this.pulsarCancelar.bind(this)

          this.plataformas=new Set()  //Set para guardar los datos introducidos
          this.aceptar=<HTMLInputElement>this.div.getElementsByTagName('button')[1]
          this.error=<HTMLElement>document.getElementById('camposrellenosEditar')
          this.vista=false
	}
     ...
     pulsarAceptar(id:number):void {
          ...
          if(this.nombre.value==''){
               ...
               let genero=<HTMLSelectElement>document.getElementById('generoEditar')
     ...
     mostrarDatos(pelicula:Pelicula){
          ...
          let gen=<HTMLInputElement>document.getElementById('generoEditar')
      ...
      */
      anadirPlataforma(elemento:string){
